...
using SIMA.Web.Abstractions;
using SIMA.Web.Areas.Catalog.Models;
using SIMA.Web.Extensions;
...
namespace SIMA.Web.Areas.Catalog.Controllers
{
    [Area("Catalog")]
