using SIMA.Application.DTOs.Identity;
using SIMA.Application.DTOs.Mail;
using SIMA.Application.DTOs.Settings;
using SIMA.Application.Enums;
using SIMA.Application.Exceptions;
using SIMA.Application.Interfaces;
...
namespace SIMA.Infrastructure.Identity.Services
{
